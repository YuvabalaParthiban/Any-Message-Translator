...
public class MainActivity2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        editText.setText(getIntent().getStringExtra("Answer"));
            ...
            public boolean onMenuItemClick(MenuItem item) {
                switch (item.getItemId()) {
                    case R.id.action_english:
                        ...
                        Toast.makeText(MainActivity2.this, "This is English", Toast.LENGTH_LONG).show();
                        break;
                    ...
                    case R.id.action_tamil:
                        ...
                        onClick(textView);
                        Toast.makeText(MainActivity2.this, "This is Tamil", Toast.LENGTH_LONG).show();
                    ...
                    case R.id.action_hindi:
                        ...
                        onClick1(textView);
                        Toast.makeText(MainActivity2.this, "This is Hindi", Toast.LENGTH_LONG).show();
                        break;
                    ...
                    case R.id.action_telugu:
                        ...
                        onClick2(textView);
                        Toast.makeText(MainActivity2.this, "This is Telugu", Toast.LENGTH_LONG).show();
                        break;
                    ...
                    case R.id.action_kannada:
                        ...
                        onClick3(textView);
                        Toast.makeText(MainActivity2.this, "This is Kannada", Toast.LENGTH_LONG).show();
                        break;
                    ...
                    case R.id.action_marathi:
                        ...
                        onClick4(textView);
                        Toast.makeText(MainActivity2.this, "This is Marathi", Toast.LENGTH_LONG).show();
                        break;
                    ...
                    case R.id.action_french:
                        ...
                        onClick5(textView);
                        Toast.makeText(MainActivity2.this, "This is French", Toast.LENGTH_LONG).show();
                        break;
